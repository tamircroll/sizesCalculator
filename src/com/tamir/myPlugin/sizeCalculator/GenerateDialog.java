...
//        setTitle("calculate?");
//
//        List<PsiField> allDoubleFields = getAllDoubleFields(psiClass);
...
//
//    @NotNull
//    private List<PsiField> getAllDoubleFields(PsiClass psiClass)
//    {
//        List<PsiField> psiFields = Arrays.asList(psiClass.getAllFields());
//        return psiFields.stream().filter(psiField -> PsiType.DOUBLE.equals(psiField.getType())).collect(Collectors.toList());
//    }
//
//    @Nullable
//    @Override
